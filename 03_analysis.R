...
# Chop the resistance raster up by the 10x10 tile grid. This takes a while but you only have to
# do it once.
resist_gridded <- st_intersection(resistance_surface, prov_grid)
